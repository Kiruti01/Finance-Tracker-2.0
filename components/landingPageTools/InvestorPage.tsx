...
import ChartAccurate from "./ChartAccurate";
import VersatileTools from "./VersatileTools";
import DynamicChart from "./DynamicChart";
import ScreenFriendly from "./ScreenFriendly";
  ...
  return (
    <div className="mt-16 flex justify-center items-center flex-col">
      <div className="text-4xl font-bold text-center">
        Let's calculate your returns through{" "}
        <span className="inline-block bg-clip-text text-transparent bg-gradient-to-l  from-[#5A32A3] to-[#D03592] ">
          TS 2.0
        </span>
      </div>
      <div className="mt-4 text-center md:w-2/3 lg:w-1/3 px-8 font-medium text-[18px]">
        With our investment calculator tools, individuals and investors can
        effortlessly plan and optimize their financial future, making informed
        investment decisions on multiple platforms
      </div>
