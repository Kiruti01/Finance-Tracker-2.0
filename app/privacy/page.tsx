...
const Page = async () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to TrackSmart 2.0.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to TrackSmart 2.0, accessible from{" "}
            <a
              href="finance-tracker-2-0.vercel.app"
              rel="external nofollow noopener"
              target="_blank"
            >
              finance-tracker-2-0.vercel.app
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: kirutitech@gmail.com</li>
      </ul>
    </div>
  );
};
