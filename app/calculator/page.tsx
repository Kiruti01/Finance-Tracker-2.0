...
const prage = () => {
  ...
  const calculateReturns = () => {
    ...
    return (
      <div className="md:h-[380px] h-fit border-[10px] lg:ml-8 mt-4 lg:mt-0 rounded-lg p-4 w-full flex justify-between items-center flex-col md:flex-row">
        <div className="flex flex-col justify-between h-full md:w-1/2 w-full p-4 md:mr-16">
          ...
          <div className="mt-4 mb-4 text-[17px] font-semibold w-full">
            ...
            <div
              className={`font-normal ${JetBrains.className} hover:bg-blue-300 dark:hover:bg-[#3b7ecb] dark:bg-slate-700 bg-blue-100 w-full rounded-lg mt-3 flex justify-center items-center select-none h-[35px] cursor-pointer`}
    ...
    <div className={`lg:mx-16 mx-4 my-8 ${InterScript.className}`}>
      ...
      <div className="flex mt-6 lg:flex-row flex-col border-b-gray-700">
        <div className="h-[380px] border-[10px] lg:w-[600px] rounded-2xl w-full">
          <div className="p-3 flex justify-between items-center">
            <div
              className="bg-gray-200 dark:bg-slate-500 rounded-lg px-3 py-1 text-[12px] text-black flex items-center space-x-1 select-none cursor-pointer hover:bg-gray-400 dark:hover:bg-[#3b7ecb]"
      ...
      <div className="mt-6 border-[10px] rounded-lg mb-8 h-fit px-2 sm:px-8 py-4 select-none">
        <div className="flex space-x-3 items-center justify-center mt-2 mb-4 text-[14px]">
          <div
            className={`rounded-lg px-2 py-1 border-2 cursor-pointer transition duration-300 dark:hover:bg-[#3b7ecb] dark:bg-slate-700 ${
              active === "Scatter" && "bg-gray-200 dark:bg-[#3b7ecb]"
            }`}
            onClick={() => {
              setActive("Scatter");
            }}
          ...
          <div
            className={`rounded-lg px-2 py-1 border-2 cursor-pointer transition duration-300 dark:hover:bg-[#3b7ecb] dark:bg-slate-700 ${
              active === "Line" && "bg-gray-200 dark:bg-[#3b7ecb]"
            }`}
            onClick={() => {
              setActive("Line");
            }}
          ...
          <div
            className={`rounded-lg px-2 py-1 border-2 cursor-pointer transition duration-300 dark:hover:bg-[#3b7ecb] dark:bg-slate-700 ${
              active === "Bubble" && "bg-gray-200 dark:bg-[#3b7ecb]"
            }`}
            onClick={() => {
              setActive("Bubble");
            }}
