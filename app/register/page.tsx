...
const Page = () => {
  ...
  return (
    <div>
      <div className="pt-8 from-[#f1f7f1] to-[#ebf4f8]">
        <div className="flex flex-col justify-center items-center pt-8 ">
          ...
          <div
            className={`sm:text-[40px] text-[20px] font-bold text-[#414141] ${JetBrains.className}`}
          >
          ...
          <div className="w-[90%] mt-4 mb-8 border md:w-[460px] rounded-2xl pt-8 pb-6 px-7.5 border-gray-400 bg-white">
            <div onClick={() => socialAction("google")} className="px-4">
              <div className="flex items-center py-3 px-3 justify-center mr-2 w-full font-semibold rounded-lg text-lg leading-none gap-x-3 bg-blue-500 text-gray-100 hover:text-white select-none cursor-pointer hover:bg-blue-600">
                Google
              </div>
            </div>

            <div className="h-[1.5px] bg-gray-100 w-11/12 mx-auto text-center mb-6 text-sm my-8 border-[1px]">
              <span className="relative -top-2.5 bg-white text-sm text-center px-2.5 select-none text-gray-500">
                Or Continue With
              </span>
            </div>
            ...
            <form onSubmit={onSubmit}>
              ...
              <div className="flex justify-center items-center my-5">
                <button
                  type="submit"
                  className="w-fit px-5 py-1 text-[18px] select-none rounded-lg cursor-pointer bg-[#29ABE2] hover:bg-[#88d4f5] text-white font-semibold"
                >
                  Register
                </button>
              </div>
            ...
            <div className="flex justify-center space-x-2 items-center my-3">
              <div className="flex text-md text-gray-600">Already a user?</div>
              <div
                className="inline-flex text-md items-center font-semibold ml-3 text-[#29abe2] cursor-pointer"
                onClick={() => {
                  router.push("/login");
                }}
              >
