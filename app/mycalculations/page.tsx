...
const Page = async () => {
  ...
  return (
    <div>
      <div
        className={`mx-16 text-center text-[35px] my-4 ${JetBrains.className} font-semibold `}
      >
        Recent{" "}
        <span className="inline-block bg-clip-text text-transparent bg-gradient-to-l  from-[#5A32A3] to-[#D03592] relative">
          Calculations
        </span>
      </div>
